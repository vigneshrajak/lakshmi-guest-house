...
2. **GPay Instructions**: On the success screen, the guest is presented with the owner's Google Pay phone number (8754170241) and a unique Booking Reference Code. Guests are instructed to GPay the 30% advance directly to the owner and include the reference code in the payment remarks.
